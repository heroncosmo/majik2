...
export default function Footer() {
  ...
  return (
    <footer id="contato" className="bg-gradient-to-br from-blue-900 via-blue-800 to-green-800 text-white">
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-neutral-300 mb-6 leading-relaxed">
              Provedor de Serviços Terceirizados há mais de 10 anos. 
            ...
            <div className="flex space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-neutral-800 rounded-lg flex items-center justify-center hover:bg-green-600 transition-colors"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-heading font-semibold mb-6">Links Úteis</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg font-heading font-semibold mb-6">Nossos Serviços</h3>
            <ul className="space-y-3">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-heading font-semibold mb-6">Atendimento</h3>
            <div className="space-y-4">
              <div>
                <p className="text-neutral-300 mb-1">{CONTACT_INFO.businessHours.weekdays}</p>
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-neutral-400 text-sm mt-2 md:mt-0">
              Desenvolvido com ❤️ para a Majik
            </p>
          </div>
        </div>
      </div>
